About langchain-ai21-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-ai21-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-ai21-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-ai21
# for installing globally
pixi global install langchain-ai21
```
...
It is possible to list all of the versions of `langchain-ai21` available on your platform:
...
```
pixi search langchain-ai21 --channel conda-forge
```
